...
def launch(context, *args, **kwargs):
    ...
    if config_file and config_file != '':
      ...
      m = Model(robot_name, model_type, [0, 0, -1.0, 0, 0, 1])
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'urdf',
            default_value='src/drone-simulator/urdf/sailboats.urdf.xacro',
            description='URDF file of the sailboat model. '),
        DeclareLaunchArgument(
            'paused',
            default_value='False',
